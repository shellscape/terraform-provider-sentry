...
// Platforms returns all valid platform values as strings for backward compatibility
// Use AllPlatformStrings() from platforms.go for the typed enum version
var Platforms = AllPlatformStrings()
